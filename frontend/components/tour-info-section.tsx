      ...
      <div className="container">
        <div className="mb-8">
          ...
          <div className="mb-6">
            ...
            <p className="text-balance font-bold text-2xl text-primary">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          <div className="flex items-center gap-3 rounded-lg border p-4">
            ...
            <div>
              <p className="text-muted-foreground text-sm">旅行日数</p>
              <p className="font-semibold">
                {tour.days}泊{tour.days + 1}日
              </p>
            </div>
          </div>
          <div className="flex items-center gap-3 rounded-lg border p-4">
            ...
            <div>
              <p className="text-muted-foreground text-sm">フライト</p>
              <p className="font-semibold">
          ...
          <div className="flex items-center gap-3 rounded-lg border p-4">
            ...
            <div>
              <p className="text-muted-foreground text-sm">ホテル</p>
